...
{
    Elimina_Cat($_GET['remove']);
}
if(isset($_POST['Aggiungi']) and !empty($_POST['NomeCat']))
{
    Crea_Cat($_POST['NomeCat']);
}
?>
<html>
<head>
    ...
    <nav class="navbar navbar-dark bg-inverse navbar-fixed-top">
        ...
        <div class="collapse navbar-collapse navbar-toggleable-sm navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav list-group ">
                ...
                <li class="list-group-item">
                    <a href="#"><i class="material-icons">folder_open</i>Categorie</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                <?php get_CategorieAdmin();?>
                </tbody>
            </table>
            <h3>Crea Nuova Categoria:</h3>
            <form action="Categorie.php" method="post">
                <input type="text" name="NomeCat" placeholder="Nome Categoria">
